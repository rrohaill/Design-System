...
/**
 * Contains default values used by [Modifier.placeholder] and [dev.rrohaill.designsystem.placeholder.DsPlaceholderHighlight].
 */
object DsPlaceholderDefaults {
    /**
 ...
 *
 * You can provide a [DsPlaceholderHighlight] which runs an highlight animation on the placeholder.
...
fun Modifier.placeholder(
    ...
    highlight: DsPlaceholderHighlight? = null,
    ...
    remember(color, shape, highlight) {
        drawWithContent {
            ...
            lastSize.value = size.takeUnless { it == Size.Unspecified } ?: Size.Zero
...
private fun DrawScope.drawPlaceholder(
    shape: Shape,
    color: Color,
    highlight: DsPlaceholderHighlight?,
    progress: Float,
    lastOutline: Outline?,
