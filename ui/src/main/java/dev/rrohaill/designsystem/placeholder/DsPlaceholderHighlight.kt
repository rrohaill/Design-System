package dev.rrohaill.designsystem.placeholder
 ...
 */
interface DsPlaceholderHighlight {
    /**
 ...
 */
fun DsPlaceholderHighlight.Companion.fade(
    highlightColor: Color,
    animationSpec: InfiniteRepeatableSpec<Float> = DsPlaceholderDefaults.fadeAnimationSpec,
): DsPlaceholderHighlight = Fade(
...
/**
 * Creates a [DsPlaceholderHighlight] which 'shimmers', using the given [highlightColor].
 *
 ...
 * Defaults to 0.6f.
 */
fun DsPlaceholderHighlight.Companion.shimmer(
    highlightColor: Color,
    animationSpec: InfiniteRepeatableSpec<Float> = DsPlaceholderDefaults.shimmerAnimationSpec,
    @FloatRange(from = 0.0, to = 1.0) progressForMaxAlpha: Float = 0.6f,
): DsPlaceholderHighlight = DsShimmer(
    highlightColor = highlightColor,
    animationSpec = animationSpec,
